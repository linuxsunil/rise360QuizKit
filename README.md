...
* 🧪 **QA Sandbox:** A dedicated "QA Preview" tab to test question logic, scores, and feedback before you export.
...
### 2. Preview & QA
Switch to the **QA Preview** tab. Here you can actually take the quiz. Ensure your partially correct logic (for MMCQs) and feedback loops are performing as expected.
...
* **Other Projects:** Developer of *Vyapar Lite*, *MCQ Studio*, and the *Bharat Snack Index*.
